...
感谢你对 **General Writing Skill** 项目的关注！我们欢迎任何形式的贡献。
...
如果你发现了 Bug，请[创建 Issue](https://github.com/ahao0625/general-writing-skill/issues/new?template=bug_report.md)，并包含以下信息：
...
如果你有新功能的想法，请[创建 Issue](https://github.com/ahao0625/general-writing-skill/issues/new?template=feature_request.md)，并包含：
...
```bash
git clone https://github.com/你的用户名/general-writing-skill.git
cd general-writing-skill
```
...
1. 查看 [现有 Issues](https://github.com/ahao0625/general-writing-skill/issues)
